...
namespace LibraryAPI.DbInitializer
{
            ...
            if (!context.Books.Any())
            {
                var books = new Book[]
                {
                    new Book
                    {
                        ...
                        ISBN = "0-670-81302-8",
                        Genres = context.Genres.Where(g => g.Name == "Horror").ToList(),
                        Authors = context.Authors.Where(a => a.Name == "Stephen").ToList(),
                        PublishingHouse = context.PublishingHouses.FirstOrDefault(p => p.Name == "Hodder & stoughton")
                    },
                    new Book{
                        Title = "nos4a2",
                        ISBN = "9788381253673",
                        Genres = context.Genres.Where(g => g.Name == "Thriller").ToList(),
                        Authors = context.Authors.Where(a => a.Name == "John").ToList(),
                        PublishingHouse = context.PublishingHouses.FirstOrDefault(p => p.Name == "William Morrow Paperbacks")
                    }
                };
            ...
            if (!context.Rents.Any())
            {
                var rents = new Rent[]
                {
                    new Rent
                    {
                        ...
                        Books = context.Books.Where(b => b.Title == "It").ToList(),
                        Employee = context.Employees.FirstOrDefault(e => e.Name == "admin")
                    },
                    new Rent
                    {
                        ...
                        Member = context.Members.FirstOrDefault(m => m.Name == "Joe"),
                        Books = context.Books.Where(b => b.Title == "nos4a2").ToList(),
                        Employee = context.Employees.FirstOrDefault(e => e.Name == "admin")
                    },
                    new Rent
                    {
                        ...
                        Member = context.Members.FirstOrDefault(m => m.Name == "John"),
